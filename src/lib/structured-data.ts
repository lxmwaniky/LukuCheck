// JSON-LD structured data for Alex Nyambura and LukuCheck
export const alexNyamburaStructuredData = {
...
export const lukuCheckStructuredData = {
  "@context": "https://schema.org",
  "@type": "WebApplication",
  "name": "LukuCheck",
  ...
  "featureList": [
    "AI-powered outfit rating",
    "Daily fashion leaderboards", 
